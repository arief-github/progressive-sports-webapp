const cardNextMatch = ({teamOne,teamTwo, pathImage, idMatch}) => {
	const render = () => {
		return `
        <div class="">
            <div class="card-game mb-6 ml-20 justify-between flex">
              <img class="h-24 w-24 mt-4" src="${pathImage}" alt="country" " />
                ...
                <button id="btn-next-match" class="rounded-[10%] w-14 h-14 fill-gray-500 my-auto shadow-md group hover:shadow-inner ">
