	        ...
	        <div class="container px-5 py-24 mx-auto max-w-7x1">
	            <div class="flex flex-wrap w-full mb-4 p-4">
	                <div class="w-full mb-6 lg:mb-0">
	                    <h1 class="sm:text-4xl text-5xl font-medium font-bold title-font mb-2 text-gray-900 dark:text-white">News</h1>
              ...
              data.articles.forEach((item) => {
            	...
            	<div class="xl:w-1/3 md:w-1/2 p-4">
	                    <div class="bg-white dark:bg-gray-800 shadow-lg p-6 rounded-lg h-full">
	                    	<img class="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72  rounded w-full object-cover object-center mb-6" src="${item.images[0].url}" alt="Image Size 720x400">				
					      	<h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">${item.published}</h3>
					        <a href="${item.links.web.href}"> <h2 class="text-lg dark:text-white text-gray-900 font-medium title-font mb-4">${item.headline}</h2></a>		           
